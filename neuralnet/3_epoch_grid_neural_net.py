...
# Path
TESTS_CSV_PATH = cwd / "tests" / "epoch_grid_neural_net_tests.csv"
...
epoch_grid = [100, 200, 500, 1000, 2000, 3000, 5000]
...
for i, hidden_layer_sizes in enumerate(hidden_layer_size_grid):
    for j, num_epochs in enumerate(epoch_grid):
